...
Формат ответа:
{
  ...
  "spirit_animal": { "name": "ЛЮБОЕ существо (мифическое, реальное, фэнтезийное — что угодно подходящее)", "description": "Почему именно это существо подходит игроку (1 предложение)", "art_description": "ALWAYS IN ENGLISH: visual description for art generator — creature pose, details, style (1-2 sentences)" },
  ...
  "psycho_profile": {
    ...
    "big_five_labels": { "openness": "Креативный ярлык", "conscientiousness": "Креативный ярлык", "extraversion": "Креативный ярлык", "agreeableness": "Креативный ярлык", "neuroticism": "Креативный ярлык" },
    "motivations": { "achievement": <0-100>, "immersion": <0-100>, "social": <0-100>, "mastery": <0-100>, "escapism": <0-100>, "curiosity": <0-100> },
    "traits": [ { "name": "Черта", "score": <0-100>, "description": "Описание черты (1-2 предложения)", "icon": "эмодзи" } ],
    "decision_style": "methodical|impulsive|completionist|optimizer|explorer",
    "decision_style_description": "Описание стиля принятия решений (1-2 предложения)",
    "social_type": "lone_wolf|pack_leader|silent_ally|social_butterfly|ghost",
    "social_type_description": "Описание социального типа (1-2 предложения)",
    "psych_summary": "3-4 предложения от игрового психолога: общий вердикт о личности игрока",
    "fictional_character": { "name": "Имя персонажа из ИГРЫ", "from": "Название игры", "reason": "Почему этот персонаж (1 предложение)" }
  }
}
...
- spirit_animal: ЛЮБОЕ существо (мифическое, реальное, фэнтезийное), НЕ из фиксированного пула. Выбирай на основе стиля игры
...
- big_five_labels: креативные геймерские ярлыки на русском (напр. "Жанровый кочевник", "Стальной перфекционист")
- traits: 4-5 уникальных черт личности с эмодзи
...
Response format:
{
  ...
  "spirit_animal": { "name": "ANY creature (mythical, real, fantasy — whatever fits best)", "description": "Why this creature fits the player (1 sentence)", "art_description": "ALWAYS IN ENGLISH: visual description for art generator — creature pose, details, style (1-2 sentences)" },
  ...
  "psycho_profile": {
    "big_five": { "openness": <0-100>, "conscientiousness": <0-100>, "extraversion": <0-100>, "agreeableness": <0-100>, "neuroticism": <0-100> },
    "big_five_labels": { "openness": "Creative label", "conscientiousness": "Creative label", "extraversion": "Creative label", "agreeableness": "Creative label", "neuroticism": "Creative label" },
    "motivations": { "achievement": <0-100>, "immersion": <0-100>, "social": <0-100>, "mastery": <0-100>, "escapism": <0-100>, "curiosity": <0-100> },
    "traits": [ { "name": "Trait name", "score": <0-100>, "description": "Trait description (1-2 sentences)", "icon": "emoji" } ],
    "decision_style": "methodical|impulsive|completionist|optimizer|explorer",
    "decision_style_description": "Description of decision-making style (1-2 sentences)",
    "social_type": "lone_wolf|pack_leader|silent_ally|social_butterfly|ghost",
    "social_type_description": "Description of social type (1-2 sentences)",
    "psych_summary": "3-4 sentences from a gaming psychologist: overall personality verdict",
    "fictional_character": { "name": "Character name from a GAME", "from": "Game title", "reason": "Why this character (1 sentence)" }
  }
}
...
- spirit_animal: ANY creature (mythical, real, fantasy), NOT from a fixed pool. Choose based on gaming style
...
- big_five_labels: creative gamer-themed labels (e.g. "Genre Nomad", "Steel Perfectionist")
- traits: 4-5 unique personality traits with emoji icons
