...
Формат ответа:
{
  ...
  "spirit_animal": { "name": "<СУЩЕСТВО ИЗ CARD DATA — spirit_animal creature>", "description": "Почему именно это существо подходит игроку (1 предложение)" },
...
Response format:
{
  ...
  "spirit_animal": { "name": "<CREATURE FROM CARD DATA — spirit_animal creature>", "description": "Why this creature fits the player (1 sentence)" },
...
- spirit_animal creature: "${creature}" (use THIS as spirit_animal name, describe why it fits)
- rarity: "${rarity}"
